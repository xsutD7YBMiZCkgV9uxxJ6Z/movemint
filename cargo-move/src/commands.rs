...
use crate::config::CargoMoveConfig;
use abscissa_core::{
    config::Override, Command, Configurable, FrameworkError, Help, Options, Runnable,
};
use std::path::PathBuf;

/// CargoMove Configuration Filename
pub const CONFIG_FILE: &str = "cargo_move.toml";
...
impl Configurable<CargoMoveConfig> for CargoMoveCmd {
    ...
    fn process_config(
        ...
        match self {
            CargoMoveCmd::Start(cmd) => cmd.override_config(config),
            _ => Ok(config),
        }
    }
}
